...
/**
 * Describes data needed by ComponentGraphComponent to draw the graph.
 */
...
export class GraphDataFactory {
   ...
   * GraphData object as needed by the ComponentGraphComponent for rendering.
   */
  static graphDataFromGQL(data: any): GraphData {
